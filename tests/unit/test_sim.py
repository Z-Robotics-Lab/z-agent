...
class TestSimulatedGripperProtocolCompliance:
    ...
    def test_isinstance_gripper_protocol(self) -> None:
        from zeno.hardware.gripper import GripperProtocol
        from zeno.hardware.sim.pybullet_gripper import SimulatedGripper
...
class TestSimPackageExports:
    ...
    def test_import_simulated_arm(self) -> None:
        from zeno.hardware.sim import SimulatedArm  # noqa: F401

    def test_import_simulated_gripper(self) -> None:
        from zeno.hardware.sim import SimulatedGripper  # noqa: F401
    ...
    def test_simulated_gripper_is_class(self) -> None:
        from zeno.hardware.sim import SimulatedGripper
