...
"""Unit tests for zeno.core.types — TDD RED phase.
...
class TestBBox3D:
    def test_construction(self):
        from zeno.core.types import BBox3D, Pose3D
...
class TestTrackedObject:
    def test_construction_minimal(self):
        from zeno.core.types import TrackedObject
    ...
    def test_construction_full(self):
        from zeno.core.types import BBox3D, Pose3D, TrackedObject
...
class TestTaskStep:
    def test_construction(self):
        from zeno.core.types import TaskStep
...
class TestTaskPlan:
    ...
    def test_clarification(self):
        from zeno.core.types import TaskPlan
...
class TestStepTrace:
    def test_construction(self):
        from zeno.core.types import StepTrace
...
class TestExecutionResult:
    ...
    def test_failure(self):
        from zeno.core.types import ExecutionResult, TaskStep
