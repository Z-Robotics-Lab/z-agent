...
- **CLI UX P1–P3.4（owner 批 P1/P2/P3.3/P3.4）**:CoT/ChainView/verdict 卡/诚实计时/trace+route/
  持久树+live_status；P3.3 多行 composer；P3.4 Claude 风格开放 input rail+大号响应式 ASCII ZENO，
  status/metadata 按字段折行、续行对齐、长 draft `100→40→100` resize 无残影。UI 簇 170P+裸 zeno PTY，0 新失败。
