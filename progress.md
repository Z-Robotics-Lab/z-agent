...
- **P5.5 TARE 探索（RED aa26a39→GREEN d292316）**：go2w_hw_explore.py::Go2WExplore
...
- **v2 route（RED a8082e4→GREEN 2cdda3e）**：go2w_hw_route.py::Go2WRouteManager 复用
...
- **v2 camera（RED c16d1ad→GREEN 5fa7404）**：go2w_hw_camera.py::Go2WCamera+CameraMixin 订
